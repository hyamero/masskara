    ...
    <section id="hero" className="relative min-h-screen overflow-x-hidden">
      <Container className="absolute left-0 right-0 top-0 z-30 flex h-screen flex-col items-start gap-14 pt-40">
        <div className="relative z-20">
          <span className="main-year font-regular font-spaceGrotesk text-[1.7rem] text-gray-300">
            2023 Festival
          </span>
          ...
          <p className="main-desc font-regular w-3/5 font-spaceGrotesk text-xl uppercase text-gray-300">
